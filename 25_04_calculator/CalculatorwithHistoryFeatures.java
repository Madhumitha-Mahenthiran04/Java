...
public class CalculatorwithHistoryFeatures {
...
System.out.println("5. Show Last N Records");
...
history.clear();
System.out.println("Our History clearedd");
} 
else if(choice.equals("4")){
System.out.println("Enter which specific index to get deleted");
int index=sc.nextInt();
if(index>=0 && index <history.size())
{
history.remove(index);
System.out.println("Your specfied histry deleted");
}
}
else if(choice.equals("5"))
{
System.out.println("Enter which record of history u needed:");
int n=sc.nextInt();
